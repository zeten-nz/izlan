...
function Wizard({ init, router }: { init: Init; router: ReturnType<typeof useRouter> }) {
  ...
  async function finish() {
    ...
    try {
      ...
      // Hand off to the learner-area router, which is the single authority on what comes next: it will send a newly
      // onboarded learner into V2 placement (/placement/v2 — fresh-start or diagnostic), then on to Today.
